...
\documentclass[%
	...
	%DIV=calc,% Mit Hilfe der Option DIV=Faktor wird festgelegt, in wie viele Streifen die Seite horizontal und vertikal bei der Satzspiegelkonstruktion eingeteilt wird. DIV=calc nimmt einem diese Arbeit ab (hängt ja auch von der Schriftart und -größe ab usw.) - verwenden, wenn geometry nicht genutzt wird
	%BCOR=0mm,% Mit Hilfe der Option BCOR=Korrektur geben Sie den absoluten Wert der Bindekorrektur an, also die Breite des Bereichs, der durch die Bindung von der Papierbreite verloren geht. Am besten in der Druckerei nachfragen! Man kann einen Wert von ca. 10mm für Arbeiten bis 100 Seiten annehmen - Verwenden, falls geometry nicht genutzt wird
	...
	captions=abovetabular% Die Beschriftungen für Tabellen sind über der Tabelle
	]{scrreprt}%
%
%
%%% HEADER und FOOTER DESIGN
\usepackage[% Header und Footer designen
	autooneside=true,% bei true werden nur die höheren Kolumnentitel in den Header geschrieben
...
\setmainlanguage[%
	...
	babelshorthands=false%Trennung wie beim Paket Babel ausschalten		
	]%
{german}%
%
%
\usepackage[T1]{fontenc}% Damit man Text sinnvoll kopieren kann (u.a. Umlaute usw. - damit ein Ü richtig im Inhaltsverzeichnis der PDF angezeigt wird
%
%
%%% SCHRIFTART
...
%
%%% TYPEAREA
\usepackage{geometry}% muss nach KOMA geladen werden. Verändert die Typearea
\geometry{left=25mm,% 
	right=30mm,%
	top=20mm,%
	bottom=20mm,%
	bindingoffset=0mm,% bindingoffset muss gesetzt werden in der Druckerei
	%showframe,% zeigt den Frame an - nur zum Debugging nutzen!
	%headsep=5mm,% Abstand des Headers zum Text
	%footskip=10mm% Abstand des Footers zum Text
	}%
%
%
%%% LEERE SEITEN
